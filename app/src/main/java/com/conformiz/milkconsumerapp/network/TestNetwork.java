...
/**
 * Created by Fahad.Munir on 03-Apr-17.
 */
...
public class TestNetwork<T> extends AsyncTask<IRequest, Integer, T> {
    ...
    public TestNetwork(Context context, Class<T> type) {
        mGson = new Gson();
        mType = type;
        this.context = context;
    }

    public TestNetwork(Context context, Class<T> type, INetworkListener<T> pNetworkListener) {
        mGson = new Gson();
        mType = type;
